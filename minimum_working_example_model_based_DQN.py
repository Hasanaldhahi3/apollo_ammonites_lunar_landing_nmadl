...
model = ModelBasedDQN(
        DummyVecEnv([lambda: gym.make('ApolloLander-v0').env]),   ##### this is the model
        ...
        model_buffer_size=0, # size of reply buffer saving data generated from model
        batch_size=1,  #buffer_size + model_buffer_size
